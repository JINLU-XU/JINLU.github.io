<template>
  <div class="detailpage">
    ...
    <div class="detail-box">
      <img class="img_auto" :src="product.large_img" alt />
      <div class="pro-name">
        <div>{{product.name}}</div>
      </div>
      <div class="produ_in_name">{{product.enname}}</div>
    </div>
    ...
    <van-goods-action>
      ...
      />
      <van-goods-action-button color="#6A91EC" text="加入购物袋" @click="addgouwud" />
      <van-goods-action-button color="#0C34BA" text="立即购买" @click="liji" />
    </van-goods-action>
  </div>
</template>

<script>
import "../assets/less/detailpage.less";
...
export default {
  ...
  methods: {
    ...
    //回到购物袋
    goShopbag() {
      this.$router.push({ name: "Gouwudai" });
    },
