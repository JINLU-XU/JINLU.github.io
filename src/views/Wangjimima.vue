<template>
  <div class="wangjimima">
    <div class="login-box">
      <van-nav-bar @click-right="goPage('Shouye')">
        <template #left>
          <div class="left-text">
            <div class="logo">
              <img class="img_auto" src="../assets/images/Rx.png" alt />
            </div>
            <div class="logo-title">Luckin Coffee</div>
          </div>
        </template>
        <template #right>
          <div class="close-box">逛一逛~</div>
        </template>
      </van-nav-bar>
        ...
        <div class="login-form-box">
          <van-form>
            ...
            <div class="clearfix forgot">
              <span class="fr" @click="goPage('Main')">已有账号，立即登录</span>
            </div>
...
<script>
import "../assets/less/wangjimima.less";
